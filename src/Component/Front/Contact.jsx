            ...
            <div className="col-lg-6 py-5 d-flex alig-items-center justify-content-center" id="contact" style={{"marginTop":"5%"}}>
                <div className="p-5 my-5 ">
                    ...
                    <div className="d-flex justify-content-center mt-5 gap-5">
                        ...
                        <a className="text-muted mr-4 d-flex flex-column align-items-center gap-2 justify-content-center" href="https://wa.me/261346470325" target="_blank" rel="noopener noreferrer"><i className="fab fa-2x fa-whatsapp"></i><small>+261 34 64 703 25</small></a>
